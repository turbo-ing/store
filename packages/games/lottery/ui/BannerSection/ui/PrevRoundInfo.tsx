...
export default function PrevRoundInfo({
  ...
  return (
    <div
      className={
        "lg:!absolute left-0 top-0 lg:!ml-[9.5vw] lg:!mt-[4.688vw] flex flex-col gap-[2.326vw] lg:!gap-[0.781vw] rounded-[2.326vw] lg:!rounded-[0.521vw] border border-left-accent bg-bg-dark p-[2.326vw] lg:!p-[0.469vw] lg:!pr-[4vw]"
      }
    >
      <div className={"flex flex-col gap-[2.326vw] lg:!gap-[0.677vw]"}>
        <span
          className={
            "font-museo text-[5.581vw] lg:!text-[1.25vw] font-bold uppercase text-left-accent"
          }
        >
          Win combination
        </span>
        <div className={"flex flex-row gap-[1.163vw] lg:!gap-[0.26vw]"}>
          {winningCombination
            ? winningCombination.map((item, index) => (
                <div
                  key={index}
                  className={
                    "flex h-[9.302vw] lg:!h-[2.083vw] w-[9.302vw] lg:!w-[2.083vw] items-center justify-center rounded-[1.163vw] lg:!rounded-[0.26vw] bg-left-accent font-museo text-[7.442vw] lg:!text-[1.667vw] font-bold text-bg-dark"
                  }
                >
                  {item}
                </div>
      ...
      <div
        className={
          "w-[70%] lg:!w-auto flex flex-row items-center justify-between"
        }
      >
        <div className={"flex flex-col gap-[1.163vw] lg:!gap-[0.677vw]"}>
          <span
            className={
              "font-museo text-[5.581vw] lg:!text-[1.25vw] font-bold uppercase text-left-accent"
            }
          ...
          <div
            className={
              "flex flex-row items-center gap-[1.163vw] lg:!gap-[0.521vw]"
            }
          >
            <Image
              src={minaImg}
              alt={"mina"}
              className={
                "h-[5.116vw] lg:!h-[1.146vw] w-[5.116vw] lg:!w-[1.146vw]"
              }
            />
            <Skeleton
              isLoading={!ticketsNum && !winningCombination}
              className={
                "h-[3.721vw] lg:!h-[0.833vw] w-full rounded-[1.163vw] lg:!rounded-[0.33vw]"
              }
            >
              <span
                className={
                  "font-museo text-[3.721vw] lg:!text-[0.833vw] font-bold text-foreground"
                }
              >
        ...
        <div className={"flex flex-col gap-[1.163vw] lg:!gap-[0.677vw]"}>
          ...
          >
            <svg
              ...
              className={"lg:!h-[1.146vw] w-[5.116vw] lg:!w-[1.146vw]"}
            >
              <path
