...
export default function CurrentRoundInfo({
  ...
  return (
    <div
      className={
        "lg:!absolute lg:!bottom-0 lg:!right-0 lg:!mr-[18vw] flex h-full w-full lg:!w-[15vw] flex-row lg:!flex-col gap-[3.488vw] lg:!gap-[0.521vw] my-[3.488vw] lg:!my-0 lg:!pt-[1vw] font-museo font-bold"
      }
    >
      <div
        className={
          "flex w-full flex-col gap-[1.163vw] lg:!gap-[0.26vw] rounded-[2.326vw] lg:!rounded-[0.67vw] border border-left-accent bg-[#252525] p-[2.326vw] lg:!p-[0.5vw]"
        }
      >
        <span
          className={
            "text-[5.581vw] lg:!text-[1.25vw] uppercase text-left-accent "
          }
        >
          Bank
        </span>
        <div
          className={
            "flex flex-row items-center gap-2 text-[3.721vw] lg:!text-[0.833vw]"
          }
        >
          <Image
            src={minaImg}
