  ...
  return (
    <>
      {networkStore.walletConnected && (
        <div
          className={cn(
            "flex flex-row gap-[1.25vw] text-base items-center",
            appchainSupported ? " justify-center" : "justify-start",
          )}
        >
          ...
          {appchainSupported && (
            <button
              className={
                "group flex w-auto ml-auto flex-row items-center justify-center gap-[10px] rounded-[5px] border border-bg-dark bg-bg-dark px-2 py-3 text-header-menu hover:bg-right-accent lg:py-1"
              }
