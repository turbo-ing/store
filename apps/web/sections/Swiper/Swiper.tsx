...
const Slides = () => {
  const slides: {
    ...
    {
      image: "https://res.cloudinary.com/dw4kivbv0/image/upload/w_2400,f_auto,fl_progressive:semi,q_auto:best/v1/store/slides/igypeqldbrsbgvfxomhc",
      ...
      <>
        <div key={"custom-lottery"} className="min-w-0 flex-[0_0_100%]">
          <div className="relative flex h-full w-full items-center justify-center">
            ...
            >
                    <span
                        className={"text-[1.302vw] text-foreground font-light"}
                    >
